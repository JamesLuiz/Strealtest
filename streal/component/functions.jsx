...
const functions = () => {
  ...
  return (
    <div>
      <h4>{title}</h4>
      <p>
        this part will demonstrate how the functions will be used along side
        their params
      </p>
      <div>
        <button
      ...
      <div>
        <button
          onClick={() =>
            depositCollateralAndMintStreal(
              "0xAcDe43b9E5f72a4F554D4346e69e8e7AC8F352f0",
              "0x673cc67E86aFc8fc84Fa5CB5197720169f495190",
              300
            )
          }
        >
        ...
        <button
          onClick={() =>
            airdropUsers(
              [
                "0x39b165389b3a0A810843376867Cced4564fA9F69",
                "0xd320cb4a09b1Fb75bD4557C2D9f2767aD72D0F3b",
              ],
              ["300", "350"]
            )
          }
        ...
        <button onClick={() => snapshot()}>Snap shot</button>
        <button onClick={() => setAirdropTime()}>set airdrop time</button>
